...
|                | Request ID**   |                |                |                                       |
+----------------+----------------+----------------+----------------+---------------------------------------+
| 06/23/2020     | N/A            | 0.1            | Shree Vidya    | Transferred content from Responding to|
|                |                |                | Jayaraman      | Nightly Validation Jive page          |
+----------------+----------------+----------------+----------------+---------------------------------------+
|                |                |                |                |                                       |
+----------------+----------------+----------------+----------------+---------------------------------------+

.. |image0| image:: ../../../_static/CoreDev/CodingIntBuild/NightlyValidation_Image0.jpg
.. |image1| image:: ../../../_static/CoreDev/CodingIntBuild/NightlyValidation_Image1.jpg
.. |image2| image:: ../../../_static/CoreDev/CodingIntBuild/NightlyValidation_Image2.jpg
.. |image3| image:: ../../../_static/CoreDev/CodingIntBuild/NightlyValidation_Image3.jpg