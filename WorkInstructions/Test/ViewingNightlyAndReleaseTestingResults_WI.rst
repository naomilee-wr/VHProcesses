...
- To access the latest Nightly Testing results developers may reference either of the following:
  ...
  - Nightly testing reports sent by the Test Team, see `Responding to Nightly Validation <../Development/RespondingToNightlyValidation_WI.html>`__ for more information
  - Login into LTAF
