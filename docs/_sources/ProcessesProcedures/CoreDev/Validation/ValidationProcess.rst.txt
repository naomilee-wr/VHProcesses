...
+--------------------------------------+--------------------------------------+
| **Entry Criteria**                   | -  Epics with committed release date |
|                                      |    and acceptance criteria are       |
|                                      |    available                         |
|                                      | -  Software design document (HLDs)   |
|                                      |    as needed, have been created      |
|                                      | -  Verification tests executed       |
|                                      | -  Release candidate build ready for |
|                                      |    validation                        |
+--------------------------------------+--------------------------------------+
| **Inputs**                           | -  Epics with committed release date |
|                                      | -  Design documents, as needed       |
|                                      | -  Verification test documents and   |
|                                      |    results                           |
|                                      | -  Release candidate build           |
|                                      | -  Known defects in the Defect       |
|                                      |    Management System                 |
+--------------------------------------+--------------------------------------+
| **Exit Criteria**                    | -  Validation completed and results  |
|                                      |    recorded                          |
...
.. list-table::
   ...
   * - 1
     - Plan for validation
     - Develop a strategy for validating the product against the committed Epics with release date.
  
       The validation strategy is documented in the Validation plan according to the Validation Plan Template. The Validation plan will be reviewed, as defined by the Document Review process and placed under configuration management.
  
       **Note:**  In cases where the program level/generic plan already exists, the release may choose to use the existing document instead of creating anew for the release.
   ...
   * - 5
     ...
     - Product Line Manager & Product Architect review/sign-off the validation results and deviations. For deviations, a change request is raised according to the Change Management Process.
  
       *Note*: Depending on the complexity and size of the product, the validator could be the Technical Feature Owner(s) instead of the Product Architect. Product Line Manager and Product Architect sign-off on the validation results.
  
       Once completed, the validation results are checked into the CM system.
...
- `Validation Test Summary Flow Diagram <../../../_static/CoreDev/Validation/VerificationValidation.jpg>`__
...
.. |image0| image:: ../../../_static/CoreDev/Validation/Validation.jpg