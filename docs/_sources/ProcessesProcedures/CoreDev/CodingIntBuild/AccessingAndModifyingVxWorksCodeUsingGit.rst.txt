...
- `Git Workflow <./VxWorksSR0520GitWorkflow-v2.pptx>`_
- `Environment setup for VxWorks 7 in Git: Setup Development Environment from Git <./SetupDevelopmentEnvironmentFromGit.html>`_ 
...
The recommended steps for setting up your environment and cloning the VxWorks 7 repository can be viewed at `Helix Product Setup Guide <./HelixProductSetupGuide.html>`_
...
- Good commit messages help give details on the commit and the impact. It provides traceability to the work.
  - `Git Commit Message Standard <./GitCommitMessageStandard.html>`_
...
(IMPORTANT!) DO NOT create merge records.  The steps on getting around the creation of merge records are clearly explained in `VxWorks SR0520 Git Workflow <./VxWorksSR0520GitWorkflow-v2.pptx>`_
...
.. |image0| image:: ../../../_static/CoreDev/CodingIntBuild/AccessingAndModifyingVxWorksCodeUsingGit_Image0.jpg 
.. |image1| image:: ../../../_static/CoreDev/CodingIntBuild/AccessingAndModifyingVxWorksCodeUsingGit_Image1.jpg 
