...
Teams are expected to actively track and groom their Feature backlog.  Prior to any release, the team is asked to commit to the content that they will release.  This document provides information on how to access Feature backlogs, expected grooming outcomes, and guidelines.
...
- Epics are created in **Backlog**
  ...
  - See `Product Manager - Jira Agile Responsibilities <ProductManager_JiraAgileResponsibilities.html>`__  
